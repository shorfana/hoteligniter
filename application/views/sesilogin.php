  ...
  <div class="overlay">
    <div class="container">
      ...
      <div class="col-md-8 col-md-offset-2">
        ...
        <a href="<?php echo base_url()."login/tamu" ?>"><button type="submit" class="btn btn-default">Tamu</button></a>
        <a href="<?php echo base_url()."login/pegawai" ?>"><button type="submit" class="btn btn-default">Pegawai</button></a>
        <a href="<?php echo base_url()."login/admin" ?>"><button type="submit" class="btn btn-default">Admin</button></a>
