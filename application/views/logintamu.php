...
<head>
  <meta charset="UTF-8">
  <title>Daily UI Challenge 001</title>
  <link href="https://fonts.googleapis.com/css?family=Josefin+Sans:400,700" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">

  
      <link rel="stylesheet" href="<?php echo base_url()?>gagah/login2/css/style.css">
...
<body>
  ...
  <div class="padding-wrap">
    ...
    <form id="sign-up-1" action="<?php echo base_url()."home" ?>">
    ...
    <span class="login">Already have an account? <a id="log-in">Log in.</a></span>
  </div>
</div>
...
<div class="form-container form-2">
  ...
  <div class="padding-wrap">
    ...
    <span id="back" class="login"><a>Go back.</a></span>
  </div>
</div>
...
<div class="form-container form-3">
  ...
  <div class="padding-wrap">
    ...
    <span class="login">No account? <a id="go-to-signup">Sign up.</a></span>
  </div>
</div>
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js'></script>
    ...
    <script  src="<?php echo base_url()?>gagah/login2/js/index.js"></script>
